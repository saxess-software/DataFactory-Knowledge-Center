/*
DELETE all ValueSeries 
This script loops over all selected products and deletes them
All ValueSeries provided through SELECT-Statement will be deleted
*/
-------------------------------------------------------------------------------------------------------------------
-- ##### VARIABLES ###########
...
BEGIN
      EXEC dbo.sx_pf_DELETE_ValueSerie 'SQL',@FactoryID, @ProductlineID, @ProductID,@ValueSeriesID
