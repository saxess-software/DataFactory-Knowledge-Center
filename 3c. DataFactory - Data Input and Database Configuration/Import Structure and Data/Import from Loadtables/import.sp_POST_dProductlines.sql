...
Import Productlines from load.tdProductlines
	EXEC [import].[sp_POST_dProductlines] '',''
*/
...
-------------------------------------------------------------------------------------------------------------------
GO
GRANT EXECUTE ON OBJECT ::[import].[sp_POST_dProductlines] TO pf_PlanningFactoryUser;
GRANT EXECUTE ON OBJECT ::[import].[sp_POST_dProductlines] TO pf_PlanningFactoryService;
GO
